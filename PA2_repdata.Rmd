...
```{r grep, echo=TRUE, cache=TRUE, message=FALSE}
...
The result we are trying to get at is which types of events (as indicated in the EVTYPE variable) are most harmful with respect to population health. For this purpose, we have processed our data in a way to show the total number of fatalities and injuries caused by different evemts.  
